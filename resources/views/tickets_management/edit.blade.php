          ...
          <div class="row">
            ...
            <div class="col-md-6">
              <div class="form-group mb-3">
                ...
                <select class="form-control @error('company') is-invalid @enderror" name="company" id="company">
                  ...
                  <option value="{{ $item->id }}" {{ $status->company_id==$item->id ? 'selected' : '' }}>{{ $item->name }}</option>
                  @endforeach
                </select>
                @error('company')
            ...
            <div class="col-md-6">
              <div class="form-group mb-3">
                ...
                <input name="name" value="{{ $status->name }}" required type="text" id="name" class="form-control @error('name') is-invalid @enderror">
                @error('name')
                <span class="invalid-feedback" role="alert">
                  <strong>{{ $message }}</strong>
                </span>
