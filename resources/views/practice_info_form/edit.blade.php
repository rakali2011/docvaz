...
<body>
  <div class="container-fluid">
    {!! Form::model($practice, ['method' => 'PATCH','route' => ['practice_info_form.update', $practice->id]]) !!}
  ...
  <script>
    ...
    $(document).on("click", "#add-thresh_payer", function() {
      var html = '<; class="row t-dynamic_add-' + t + '"><div class="col-md-12 t-dynamic_add-' + t + '">' +
        '<div class="mb-3">' +
    ...
    $(document).on("click", "#add-payers_enrollment", function() {
      ...
      var html = '<div class="col-md-2 e-dynamic_add-' + e + '">' +
        '<div class="mb-3">' +
