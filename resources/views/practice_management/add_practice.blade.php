                  ...
                  <div class="container">
                    <div class="accordion" id="faq">
                      ...
                      <div class="card">
                        ...
                        <div id="faq1" class="collapse" aria-labelledby="accordion1" data-parent="#faq">
                          <div class="card-body">
                            <div class="row">
                              <div class="col-md-4">
                                <div class="mb-3">
                                  <label for="practice" class="form-label">Practice Name</label>
                                  <input type="text" onkeyup="this.value=upercase(this.value);" onkeyup="this.value=upercase(this.value);" class="form-control" id="practice" name="practice">
                                </div>
                              </div>
                              <div class="col-md-4">
                                <div class="mb-3">
                                  <label for="speciality" class="form-label">Speciality</label>
                                  <input type="text" sty onkeyup="this.value=upercase(this.value);" onkeyup="this.value=upercase(this.value);" data-role="tagsinput" class="form-control" name="speciality" id="speciality" value="" />
                                </div>
                              </div>
                              <div class="col-md-4">
                                <div class="mb-3">
                                  <label for="avg_charges" class="form-label">Average Monthly Collection</label>
                                  <input type="text" onkeyup="this.value=upercase(this.value);" value="" class="form-control" id="avg_charges" name="avg_charges" />
                                </div>
                              </div>
                              ...
                              <div class="col-md-4">
                                <div class="mb-3">
                                  ...
                                  <input maxlength="10" type="text" onkeyup="this.value=upercase(this.value);" value="" class="form-control" id="group_npi" name="group_npi" onkeypress="return validateNumber(event)" />
                                </div>
                              </div>
                              <div class="col-md-4">
                                <div class="mb-3">
                                  <label for="group_ptan" class="form-label">Group PTAN</label>
                                  <input type="text" onkeyup="this.value=upercase(this.value);" value="" class="form-control" id="group_ptan" name="group_ptan" onkeypress="return validateAlphaNumeric(event)" />
                                </div>
                              </div>
                              <div class="col-md-4">
                                <div class="mb-3">
                                  <label for="tax_id" class="form-label">Tax ID</label>
                                  <input type="text" onchange="this.value=rtax(this.value);" maxlength="10" onkeyup="this.value=upercase(this.value);" value="" class="form-control" id="tax_id" name="tax_id" onkeypress="return validateNumber(event)" />
                                </div>
                              </div>
                            </div>
                          </div>
                              ...
                              <div id="physical_address" class="row">
                                <div class="col-md-3 p-dynamic_add-">
                                  <div class="mb-3">
                                    ...
                                    <input type="text" onkeyup="this.value=upercase(this.value);" onkeyup="this.value=upercase(this.value);" value="" class="form-control" id="physical_address-" name="physical_address[]" />
                                  </div>
                                </div>
                                <div class="col-md-2 p-dynamic_add-">
                                  <div class=" mb-3">
                                    <label for="physical_zip-" class="form-label">Zip</label>
                                    <input type="text" onkeyup="this.value=upercase(this.value);" value="" class="form-control" id="physical_zip-" name="physical_zip[]" />
                                  </div>
                                </div>
                                <div class="col-md-3 p-dynamic_add-">
                                  <div class=" mb-3">
                                    <label for="physical_state-" class="form-label">State</label>
                                    <input type="text" onkeyup="this.value=upercase(this.value);" class="form-control" value="" id="physical_state-" name="physical_state[]" />
                                  </div>
                                </div>
                                <div class="col-md-3 p-dynamic_add-">
                                  <div class=" mb-3">
                                    <label for="physical_city" class="form-label">City</label>
                                    <input type="text" onkeyup="this.value=upercase(this.value);" class="form-control" value="" id="physical_city" name="physical_city[]" />
                                  </div>
                                </div>
                              ...
                              <div id="mailing_address" class="row">
                                <div class="col-md-3 m-dynamic_add-">
                                  <div class="mb-3">
                                    ...
                                    <input type="text" onkeyup="this.value=upercase(this.value);" class="form-control" value="" id="mailing_address-" name="mailing_address[]" />
                                  </div>
                                </div>
                                <div class="col-md-2 m-dynamic_add-">
                                  <div class="mb-3">
                                    <label for="mailing_zip-" class="form-label">Zip</label>
                                    <input type="text" onkeyup="this.value=upercase(this.value);" class="form-control" value="" id="mailing_zip-" name="mailing_zip[]" />
                                  </div>
                                </div>
                                <div class="col-md-3 m-dynamic_add-">
                                  <div class="mb-3">
                                    <label for="mailing_state-" class="form-label">State</label>
                                    <input type="text" onkeyup="this.value=upercase(this.value);" class="form-control" value="" id="mailing_state-" name="mailing_state[]" />
                                  </div>
                                </div>
                                <div class="col-md-3 m-dynamic_add-">
                                  <div class="mb-3">
                                    <label for="mailing_city-" class="form-label">City</label>
                                    <input type="text" onkeyup="this.value=upercase(this.value);" class="form-control" value="" id="mailing_city-" name="mailing_city[]" />
                                  </div>
                                </div>
                              ...
                              <div id="service_location" class="row">
                                <div class="col-md-3 la-dynamic_add-">
                                  <div class="mb-3">
                                    ...
                                    <input type="text" onkeyup="this.value=upercase(this.value);" class="form-control" value="" id="location_address-" name="location_address[]" />
                                  </div>
                                </div>
                                <div class="col-md-2 la-dynamic_add-">
                                  <div class="mb-3">
                                    <label for="location_zip-" class="form-label">Zip</label>
                                    <input type="text" onkeyup="this.value=upercase(this.value);" class="form-control" value="" id="location_zip-" name="location_zip[]" />
                                  </div>
                                </div>
                                <div class="col-md-3 la-dynamic_add-">
                                  <div class="mb-3">
                                    <label for="location_state-" class="form-label">State</label>
                                    <input type="text" onkeyup="this.value=upercase(this.value);" class="form-control" value="" id="location_state-" name="location_state[]" />
                                  </div>
                                </div>
                                <div class="col-md-3 la-dynamic_add-">
                                  <div class="mb-3">
                                    <label for="location_city-" class="form-label">City</label>
                                    <input type="text" onkeyup="this.value=upercase(this.value);" class="form-control" value="" id="location_city-" name="location_city[]" />
                                  </div>
                                </div>
                      ...
                      <div class="card">
                        ...
                        <div id="faq3" class="collapse" aria-labelledby="accordion3" data-parent="#faq">
                          <div class="row">
                            <div class="card-body">
                              <div class="col-md-12">
                                <div id="owner_info" class="row">
                                  <div class="col-md-2 o-dynamic_add-">
                                    <div class="mb-3">
                                      ...
                                      <input type="text" name="owner_title[]" id="owner_title-" onkeyup="this.value=upercase(this.value);" value="" class="form-control">
                                    </div>
                                  </div>
                                  <div class="col-md-3 o-dynamic_add-">
                                    <div class="mb-3">
                                      <label for="owner_name-" class="form-label">Owner/Prov Name</label>
                                      <input type="text" onkeyup="this.value=upercase(this.value);" value="" class="form-control" id="owner_name-" name="owner_name[]" />
                                    </div>
                                  </div>
                                  <div class="col-md-2 o-dynamic_add-">
                                    <div class="mb-3">
                                      <label for="owner_fax-" class="form-label">Fax</label>
                                      <input type="text" onkeyup="this.value=upercase(this.value);" class="form-control" value="" id="owner_fax-" name="owner_fax[]" onchange="this.value=formatPhoneNumber(this.value);" />
                                    </div>
                                  </div>
                                  <div class="col-md-2 o-dynamic_add-">
                                    <div class="mb-3">
                                ...
                                <div id="focal_info" class="row">
                                  <div class="col-md-3 f-dynamic_add-">
                                    <div class="mb-3">
                                      ...
                                      <input type="text" onkeyup="this.value=upercase(this.value);" class="form-control" value="" id="focal_name-" name="focal_name[]" />
                                    </div>
                                  </div>
                                  <div class="col-md-2 f-dynamic_add-">
                                    <div class="mb-3">
                                      <label for="focal_fax-" class="form-label">Fax</label>
                                      <input type="text" onkeyup="this.value=upercase(this.value);" class="form-control" value="" id="focal_fax-" name="focal_fax[]" />
                                    </div>
                                  </div>
                                  <div class="col-md-2 f-dynamic_add-">
                                    <div class="mb-3">
                                  ...
                                  <div class="col-md-2 f-dynamic_add-">
                                    <div class="mb-3">
                                      ...
                                      <input type="text" name="focal_designation[]" id="focal_designation-" class="form-control" value="" onkeyup="this.value=upercase(this.value);" />
                                    </div>
                                  </div>
                              ...
                              <div class="col-md-12">
                                <div class="mb-3">
                                  ...
                                  <input type="text" onkeyup="this.value=upercase(this.value);" value="" class="form-control" id="dmail_emails" name="dmail_emails" />
                                </div>
                              </div>
                            </div>
                          </div>
                      ...
                      <div class="card">
                        ...
                        <div id="faq4" class="collapse" aria-labelledby="accordion4" data-parent="#faq">
                          <div class="card-body">
                            <div class="row">
                              <div class="col-md-3">
                                <div class="mb-3">
                            ...
                            <div class="row" id="practice-info-tab">
                              <div class="col-md-2 pi-dynamic_add-">
                                <div class="mb-3">
                                  ...
                                  <input type="text" name="provider_name[]" id="provider_name-" onkeyup="this.value=upercase(this.value);" value="" class="form-control">
                                </div>
                              </div>
                              <div class="col-md-2 pi-dynamic_add-">
                                <div class="mb-3">
                              ...
                              <div class="col-md-2 pi-dynamic_add-">
                                <div class="mb-3">
                                  ...
                                  <input maxlength="10" type="text" name="provider_ind_npi[]" id="provider_ind_npi-" onkeyup="this.value=upercase(this.value);" value="" class="form-control" onkeypress="return validateNumber(event)" maxlength="10">
                                </div>
                              </div>
                              <div class="col-md-2 5 pi-dynamic_add-">
                                <div class="mb-3">
                                  <label for="individual_ptan" class="form-label">Individual PTAN</label>
                                  <input type="text" name="individual_ptan[]" id="individual_ptan-" onkeyup="this.value=upercase(this.value);" value="" class="form-control" onkeypress="return validateAlphaNumeric(event)">
                                </div>
                              </div>
                              <div class="col-md-2 pi-dynamic_add-">
                                <div class="mb-3">
                                  <label for="provider_ssn" class="form-label">Provider SSN#</label>
                                  <input type="text" name="provider_ssn[]" id="provider_ssn-" onchange="this.value=rtaxx(this.value);" onkeyup="this.value=upercase(this.value);" value="" class="form-control" onkeypress="return validateNumber(event)" />
                                </div>
                              </div>
                              <div class="col-md-1 pi-dynamic_add-">
                                <div class="mb-3">
                                  <label for="provider_tax_id-" class="form-label">Tax ID</label>
                                  <input type="text" onchange="this.value=rtax(this.value);" maxlength="10" onkeyup="this.value=upercase(this.value);" value="" class="form-control" id="provider_tax_id-" name="provider_tax_id[]" onkeypress="return validateNumber(event)" />
                                </div>
                              </div>
                            ...
                            <div id="practice_management" class="row">
                              <div class="col-md-3 p-dynamic_add-">
                                <div class="mb-3">
                                  ...
                                  <input type="text" onkeyup="this.value=upercase(this.value);" class="form-control" value="" id="pms_name-" name="pms_name[]" />
                                </div>
                              </div>
                              <div class="col-md-3 p-dynamic_add-">
                                <div class="mb-3">
                            ...
                            <div class="row">
                              <div class="col-md-2">
                                <div class="mb-3">
                                  ...
                                  <input type="text" onkeyup="this.value=upercase(this.value);" value="" class="form-control" id="ehr_name" name="ehr_name" />
                                </div>
                              </div>
                              <div class="col-md-2">
                                <div class="mb-3">
                            ...
                            <div class="row">
                              <div class="col-md-2 e-dynamic_add-">
                                <div class="mb-3">
                                  ...
                                  <input type="text" onkeyup="this.value=upercase(this.value);" class="form-control" value="" id="payer_name-" name="payer_name[]" />
                                </div>
                              </div>
                              <div class="col-md-2 e-dynamic_add-">
                                <div class="mb-3">
                                  <label for="payer_provider_name-" class="form-label">Provider Name</label>
                                  <input type="text" onkeyup="this.value=upercase(this.value);" class="form-control payer_provider_name" value="" id="payer_provider_name-" name="payer_provider_name[]" />
                                </div>
                              </div>
                              <div class="col-md-1 e-dynamic_add-">
                                <div class="mb-3">
                                  <label for="payer_npi-" class="form-label">NPI</label>
                                  <input type="text" onkeyup="this.value=upercase(this.value);" class="form-control payer_npi" value="" id="payer_npi-" name="payer_npi[]" />
                                </div>
                              </div>
                              <div class="col-md-2 e-dynamic_add-">
                                <div class="mb-3">
                      ...
                      <div class="card">
                        ...
                        <div id="faq8" class="collapse" aria-labelledby="accordion8" data-parent="#faq">
                          <div class="card-body">
                            <div class="row">
                              <div class="col-md-3">
                                <div class="mb-3">
                      ...
                      <div class="card">
                        ...
                        <div id="faq9" class="collapse" aria-labelledby="accordion9" data-parent="#faq">
                      ...
                      <div class="card">
                        ...
                        <div id="faq10" class="collapse" aria-labelledby="accordion10" data-parent="#faq">
                          <div class="card-body">
                            <div class="row">
                              <div class="col-md-3">
                            ...
                            <div class="row" style="margin-top:40px;">
                              <div class="col-md-5">
                                <div class="mb-3">
                                  ...
                                  <input type="text" onkeyup="this.value=upercase(this.value);" class="form-control" name="key_billing_issues" id="key_billing_issues" value="" />
                                </div>
                              </div>
                              <div class="col-md-5">
                                <div class="mb-3">
                                  <label for="complementary_services" class="form-label">Complementary Services/Special Commitment (If Any)</label>
                                  <input type="text" onkeyup="this.value=upercase(this.value);" class="form-control" name="complementary_services" id="complementary_services" value="" />
                                </div>
                              </div>
                              <div class="col-md-5">
                                <div class="mb-3">
                                  <label for="special_instructions" class="form-label">Special Instructions</label>
                                  <input type="text" onkeyup="this.value=upercase(this.value);" class="form-control" name="special_instructions" id="special_instructions" value="" />
                                </div>
                              </div>
                            </div>
                          </div>
                      ...
                      <div class="card">
                        ...
                        <div id="faq12" class="collapse" aria-labelledby="accordion12" data-parent="#faq">
                          <div class="card-body">
                            <div class="row">
                              <div class="col-md-4">
                                <div class="mb-3">
                      ...
                      <div class="card">
                        ...
                        <div id="faq13" class="collapse" aria-labelledby="accordion13" data-parent="#faq">
                          <div class="card-body">
                            <div class="row">
                              <div class="col-md-4">
                                <div class="mb-3">
                      ...
                      <div class="card">
                        ...
                        <div id="faq14" class="collapse" aria-labelledby="accordion14" data-parent="#faq">
                          <div class="card-body">
                            <div class="row">
                              <div class="col-md-3">
                                <div class="mb-3">
                                ...
                                <div class="row">
                                  ...
                                  <div class="col-md-12 t-dynamic_add-">
                                    <div class="mb-3">
                                      ...
                                      <input type="text" onkeyup="this.value=upercase(this.value);" class="form-control" value="" id="thresh_payer_name-" name="thresh_payer_name[]" />
                                    </div>
                                  </div>
                                  <div class="col-md-12 t-dynamic_add-">
                                    <div class="mb-3">
...
<script>
  ...
  $(document).on("click", "#add-provider-info", function() {
    var html =
      ...
      '<input type="text" id="provider_name-' + pi + '" name="provider_name[]" onkeyup="this.value=upercase(this.value);" class="form-control">' +
      '</div>' +
      '</div>' +
      '<div class="col-md-2 pi-dynamic_add-' + pi + '">' +
      '<div class="mb-3">' +
      ...
      '<input type="text" id="provider_ind_npi-' + pi + '" name="provider_ind_npi[]" onkeyup="this.value=upercase(this.value);" class="form-control" onkeypress="return validateNumber(event)" maxlength="10">' +
      '</div>' +
      '</div>' +
      '<div class="col-md-2 pi-dynamic_add-' + pi + '">' +
      '<div class="mb-3">' +
      '<label for="individual_ptan-' + pi + '" class="form-label">Individual PTAN</label>' +
      '<input type="text" id="individual_ptan-' + pi + '" name="individual_ptan[]" onkeyup="this.value=upercase(this.value);" class="form-control" onkeypress="return validateAlphaNumeric(event)">' +
      '</div>' +
      '</div>' +
      '<div class="col-md-2 pi-dynamic_add-' + pi + '">' +
      '<div class="mb-3">' +
      '<label for="provider_ssn-' + pi + '" class="form-label">Provider SSN#</label>' +
      '<input type="text" id="provider_ssn-' + pi + '" name="provider_ssn[]" onkeyup="this.value=upercase(this.value);" class="form-control" onkeypress="return validateAlphaNumeric(event)">' +
      '</div>' +
      '</div>' +
      '<div class="col-md-1 pi-dynamic_add-' + pi + '">' +
      '<div class="mb-3">' +
      '<label for="provider_tax_id-' + pi + '" class="form-label">Tax ID</label>' +
      '<input type="text" id="provider_tax_id-' + pi + '" name="provider_tax_id[]" onkeyup="this.value=upercase(this.value);" class="form-control" onkeypress="return validateAlphaNumeric(event)">' +
      '</div>' +
      '</div>' +
  ...
  $(document).on("click", "#add-thresh_payer", function() {
    var html = '<div class="row t-dynamic_add-' + t + '"><div class="col-md-12 t-dynamic_add-' + t + '">' +
      ...
      '<input type="text"  onkeyup="this.value=upercase(this.value);" class="form-control" id="thresh_payer_name-' + t + '" name="thresh_payer_name[]" />' +
      '</div>' +
      '</div>' +
  ...
  $(document).on("click", "#add-practice_management", function() {
    var html = '<div class="col-md-3 p-dynamic_add-' + p + '" >' +
      ...
      '<input type="text"  onkeyup="this.value=upercase(this.value);" class="form-control" id="pms_name-' + p + '" name="pms_name[]" />' +
      '</div>' +
      '</div>' +
  ...
  $(document).on("click", "#add-owner_info", function() {
    var html = '<div class="col-md-2 o-dynamic_add-' + o + '" >' +
      ...
      '<input type="text" id="owner_title-' + o + '" name="owner_title[]" onkeyup="this.value=upercase(this.value);" class="form-control">' +
      '</div>' +
      '</div>' +
      '<div class="col-md-3 o-dynamic_add-' + o + '">' +
      '<div class="mb-3">' +
      '<label for="owner_name-' + o + '" class="form-label">Owner/Prov Name</label>' +
      '<input type="text"  onkeyup="this.value=upercase(this.value);" class="form-control" id="owner_name-' + o + '" name="owner_name[]" />' +
      '</div>' +
      '</div>' +
      '<div class="col-md-2 o-dynamic_add-' + o + '">' +
      '<div class="mb-3">' +
      '<label for="owner_fax-' + o + '" class="form-label">Fax</label>' +
      '<input type="text"  onkeyup="this.value=upercase(this.value);" class="form-control" id="owner_fax-' + o + '" name="owner_fax[]" />' +
      '</div>' +
      '</div>' +
      '<div class="col-md-2 o-dynamic_add-' + o + '">' +
      '<div class="mb-3">' +
  ...
  $(document).on("click", "#add-focal_info", function() {
    var html = '<div class="col-md-3 f-dynamic_add-' + f + '">' +
      ...
      '<input type="text"  onkeyup="this.value=upercase(this.value);" class="form-control" id="focal_name-' + f + '" name="focal_name[]" />' +
      '</div>' +
      '</div>' +
      '<div class="col-md-2 f-dynamic_add-' + f + '">' +
      '<div class="mb-3">' +
      '<label for="focal_fax-' + f + '" class="form-label">Fax</label>' +
      '<input type="text"  onkeyup="this.value=upercase(this.value);" class="form-control" id="focal_fax-' + f + '" name="focal_fax[]" />' +
      '</div>' +
      '</div>' +
      '<div class="col-md-2 f-dynamic_add-' + f + '">' +
      '<div class="mb-3">' +
      ...
      '<input type="text"  onkeyup="this.value=upercase(this.value);" class="form-control" id="focal_designation-' + f + '" name="focal_designation[]" />' +
      '</div>' +
      '</div>' +
  ...
  $(document).on("click", "#add-physical_address", function() {
    var html = '<div class="col-md-3 p-dynamic_add-' + i + '">' +
      ...
      '<input type="text"  onkeyup="this.value=upercase(this.value);" class="form-control" id="physical_address-' + i + '" name="physical_address[]" />' +
      '</div>' +
      '</div>' +
      '<div class="col-md-2 p-dynamic_add-' + i + '">' +
      '<div class="mb-3">' +
      '<label for="physical_zip-' + i + '" class="form-label">Zip</label>' +
      '<input type="text"  onkeyup="this.value=upercase(this.value);" class="form-control" id="physical_zip-' + i + '" name="physical_zip[]" />' +
      '</div>' +
      '</div>' +
      '<div class="col-md-3 p-dynamic_add-' + i + '">' +
      '<div class="mb-3">' +
      '<label for="physical_state-' + i + '" class="form-label">State</label>' +
      '<input type="text"  onkeyup="this.value=upercase(this.value);" class="form-control" id="physical_state-' + i + '" name="physical_state[]"/>' +
      '</div>' +
      '</div>' +
      '<div class="col-md-3 p-dynamic_add-' + i + '">' +
      '<div class="mb-3">' +
      '<label for="physical_city-' + i + '" class="form-label">City</label>' +
      '<input type="text"  onkeyup="this.value=upercase(this.value);" class="form-control" id="physical_city-' + i + '" name="physical_city[]" />' +
      '</div>' +
      '</div>' +
  ...
  $(document).on("click", "#add-mailing_address", function() {
    var html = '<div class="col-md-3 m-dynamic_add-' + x + '">' +
      ...
      '<input type="email" onkeyup="this.value=upercase(this.value);" class="form-control" id="mailing_address-' + x + '" name="mailing_address[]" />' +
      '</div>' +
      '</div>' +
      '<div class="col-md-2 m-dynamic_add-' + x + '">' +
      '<div class="mb-3">' +
      '<label for="mailing_zip-' + x + '" class="form-label">Zip</label>' +
      '<input type="text"  onkeyup="this.value=upercase(this.value);" class="form-control" id="mailing_zip-' + x + '" name="mailing_zip[]" />' +
      '</div>' +
      '</div>' +
      '<div class="col-md-3 m-dynamic_add-' + x + '">' +
      '<div class="mb-3">' +
      '<label for="mailing_state-' + x + '" class="form-label">State</label>' +
      '<input type="text"  onkeyup="this.value=upercase(this.value);" class="form-control" id="mailing_state-' + x + '" name="mailing_state[]" />' +
      '</div>' +
      '</div>' +
      '<div class="col-md-3 m-dynamic_add-' + x + '">' +
      '<div class="mb-3">' +
      '<label for="mailing_city-' + x + '" class="form-label">City</label>' +
      '<input type="text"  onkeyup="this.value=upercase(this.value);" class="form-control" id="mailing_city-' + x + '" name="mailing_city[]" />' +
      '</div>' +
      '</div>' +
  ...
  $(document).on("click", "#add-location_address", function() {
    var html = '<div class="col-md-3 la-dynamic_add-' + la + '">' +
      ...
      '<input type="email" onkeyup="this.value=upercase(this.value);" class="form-control" id="location_address-' + la + '" name="location_address[]" />' +
      '</div>' +
      '</div>' +
      '<div class="col-md-2 la-dynamic_add-' + la + '">' +
      '<div class="mb-3">' +
      '<label for="location_zip-' + la + '" class="form-label">Zip</label>' +
      '<input type="text"  onkeyup="this.value=upercase(this.value);" class="form-control" id="location_zip-' + la + '" name="location_zip[]" />' +
      '</div>' +
      '</div>' +
      '<div class="col-md-3 la-dynamic_add-' + la + '">' +
      '<div class="mb-3">' +
      '<label for="location_state-' + la + '" class="form-label">State</label>' +
      '<input type="text"  onkeyup="this.value=upercase(this.value);" class="form-control" id="location_state-' + la + '" name="location_state[]" />' +
      '</div>' +
      '</div>' +
      '<div class="col-md-3 la-dynamic_add-' + la + '">' +
      '<div class="mb-3">' +
      '<label for="location_city-' + la + '" class="form-label">City</label>' +
      '<input type="text"  onkeyup="this.value=upercase(this.value);" class="form-control" id="location_city-' + la + '" name="location_city[]" />' +
      '</div>' +
      '</div>' +
  ...
  $(document).on("click", "#add-payers_enrollment", function() {
    ...
    var html = '<div class="row e-dynamic_add-' + e + '"><div class="col-md-2 e-dynamic_add-' + e + '">' +
      ...
      '<input type="text"  onkeyup="this.value=upercase(this.value);" class="form-control"  id="payer_name-' + e + '" name="payer_name[]" />' +
      '</div>' +
      '</div>' +
      '<div class="col-md-2 e-dynamic_add-' + e + '">' +
      '<div class="mb-3">' +
      '<label for="payer_provider_name-' + e + '" class="form-label">Provider Name</label>' +
      '<input type="text"  onkeyup="this.value=upercase(this.value);" class="form-control payer_provider_name" ' +
      ...
      '<input type="text"  onkeyup="this.value=upercase(this.value);" class="form-control payer_npi" ' +
